...
const MiddlePage = () => {
  return (
    <div className="text-white grid grid-cols-1 md:grid-cols-2 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-40 gap-6 md:gap-8 lg:gap-30 py-12 sm:py-16 md:py-20 lg:min-h-screen lg:py-0 lg:items-center">
      {/* Left Column */}
      ...
      <div className="flex flex-col justify-center pt-12">
        <img
          src="/solo.jpg"
          alt="team image"
          className="grayscale hover:grayscale-0 transition-all duration-300 rounded-2xl w-3/4 h-auto object-cover aspect-square md:aspect-auto shadow-lg"
        />
