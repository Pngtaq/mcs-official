...
const ServicesContent = ({ serviceData }) => {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 text-white border border-white/20 shadow-xl transition-all duration-500 animate-fadeIn">
      {/* Title Section */}
      <div className="mb-6 sm:mb-8">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent pb-2">
          {serviceData.title}
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
        {/* Features Card */}
        <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-[#fdc835]/30 transition-all duration-300 hover:shadow-lg hover:shadow-[#fdc835]/10">
        ...
        <div className="bg-gradient-to-br from-[#fdc835]/20 via-[#fdc835]/10 to-transparent backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#fdc835]/30 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
      ...
      {/* Info Banner */}
      <div className="relative bg-gradient-to-r from-[#fdc835]/20 to-[#fdc835]/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-[#fdc835]/40 overflow-hidden">
        ...
        <div className="relative flex items-start gap-2 sm:gap-3">
          ...
          <div>
            <p className="text-xs sm:text-sm text-gray-200 leading-relaxed">
              ...
              All services include a free initial consultation. Contact our team
